...
import { useTimesheetEntryContextMenu } from '../hooks/useTimesheetEntryContextMenu';
import TimesheetDesktopWeekView from './TimesheetDesktopWeekView';
import TimesheetMobileWeekView from './TimesheetMobileWeekView';
      ...
      <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 xl:grid-cols-[320px_minmax(0,1fr)]">
          <TimesheetSidebar
            ...
            getEntryProjectLabel={getEntryProjectLabel}
              ...
              {loading ? (
                ...
                <>
                  <TimesheetMobileWeekView
                    ...
                    formatEntryWindow={formatEntryWindow}
                    getEntryProjectLabel={getEntryProjectLabel}
                    handleSelectMobileDay={handleSelectMobileDay}
                  ...
                  <TimesheetDesktopWeekView
                    activeEntry={activeEntry}
                    composerEntryDate={composer.entryDate}
                    currentUserId={currentUserId}
                    defaultTimelineHeight={defaultTimelineHeight}
                    desktopGridTemplate={desktopGridTemplate}
                    desktopWeekDays={desktopWeekDays}
                    duplicateDraft={duplicateDraft}
                    entriesByDay={entriesByDay}
                    formatEntryWindow={formatEntryWindow}
                    getEntryBlockMetrics={getEntryBlockMetrics}
                    getEntryProjectLabel={getEntryProjectLabel}
                    gridHeight={gridHeight}
                    handleDesktopDraftPlacement={handleDesktopDraftPlacement}
                    hourLabel={hourLabel}
                    hourMarks={hourMarks}
                    onSelectEntry={onSelectEntry}
