...
const PRICE_IDS = {
  monthly: 'price_1T9R96GsgkWNV5UWrXLwysfd',
  annual: 'price_1T9R9tGsgkWNV5UW4Gn4UBDu',
};
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const sessionParams = {
      ...
      success_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://project-manager-app-tau.vercel.app'}?checkout=success`,
      cancel_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://project-manager-app-tau.vercel.app'}?checkout=cancelled`,
